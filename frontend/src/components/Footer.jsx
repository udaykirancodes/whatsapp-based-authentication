                        ...
                        <div className="w-full p-6 md:w-1/2 lg:w-5/12">
                            <div className="flex h-full flex-col justify-between">
                                <div className="mb-4 inline-flex items-center">
                                    ...
                                    <span className="ml-4 text-lg font-bold">Auth System</span>
                                </div>
                                <div>
                        ...
                        <div className="w-full p-6 md:w-1/2 lg:w-2/12">
                            <div className="h-full">
                                ...
                                <ul>
                                    <li className="mb-4">
                                        <a
                                            className=" text-whtie font-medium text-[gray] hover:text-white"
                                            href="#"
                                        >
                                            Features
                                        </a>
                                    ...
                                    <li className="mb-4">
                                        <a
                                            className=" text-base font-medium text-[gray] hover:text-white"
                                            href="#"
                                        >
                                            Pricing
                                        </a>
                        ...
                        <div className="w-full p-6 md:w-1/2 lg:w-2/12">
                            <div className="h-full">
                                ...
                                <ul>
                                    <li className="mb-4">
                                        <a
                                            className=" text-base font-medium text-[gray] hover:text-gray-700"
                                            href="#"
                                        >
                                            Account
                                        </a>
